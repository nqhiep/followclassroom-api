...
const gradeBoardRuoter = require('./components/grade_board');
...
var whitelist = ['http://localhost:3001', 'https://follmeclassroom.herokuapp.com', 'https://follclassroom.herokuapp.com', 'followclassroom-fe.vercel.app'];
...
app.use('/gradeboard', gradeBoardRuoter);
